...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!userData.email && !userData.nickname ||
        !userData.nickname === "admin" && !userData.email === "fedoseevnikita1110@gmail.com") {
        showLoginOverlay();
    } else {
        hideLoginOverlay();
        hideNicknameOverlay();
    ...
    function sendOtp(email) {
        ...
        emailjs.send("service_5jpmtkn", "template_fm2emqs", templateParams)
            .then(function () {
